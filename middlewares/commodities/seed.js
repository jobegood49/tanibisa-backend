module.exports = [
  {
    name: 'Asparagus',
    description:
      'Asparagus — the green vegetable known for its slender spears — is often one of the first signs of spring. (1,2) It’s a natural addition to many spring dishes, from veggie-packed frittatas to salads piled high with the season’s finest ingredients.',
    image:
      'https://regopantes.imgix.net/commodities/3bcf81e0-3351-48c7-a5f2-bb725d59fd55.jpg?w=250',
    tags: ['asparagus', 'vegetables', 'benefits']
  },
  {
    name: 'Sweet Corn',
    description:
    ...
    image:
      'https://regopantes.imgix.net/commodities/180173dd-40a1-4062-a2de-7ceff4d9529c.png?w=300',
    tags: ['corn', 'vegetables', 'benefits']
  },
  {
    name: 'Black Rice',
    description:
